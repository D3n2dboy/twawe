 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".cleaning__slider")) swiper = new core(".cleaning__slider", {
        ...
        function isLastGroup() {
            ...
            const slidesPerPage = swiper.params.slidesPerGroup * swiper.params.grid.rows;
        ...
        function fadeSwitch(direction) {
            if (direction === "next" && isLastGroup()) return;
            if (direction === "prev" && isFirstGroup()) return;
            const slider = document.querySelector(".swiper");
            slider.classList.add("_fade-active");
            setTimeout((() => {
                if (direction === "next") swiper.slideNext(0, false); else swiper.slidePrev(0, false);
        ...
        var script_elements = document.querySelectorAll(".item-cooperation__number");
        ...
        function checkVisibleItems() {
            script_elements.forEach((function(el) {
                if (isVisible(el)) el.classList.add("visible");
            }));
            elementsTitle.forEach((function(el) {
                if (isVisible(el)) el.classList.add("active");
            }));
        }
